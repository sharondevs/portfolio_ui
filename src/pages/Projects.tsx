...
const Projects = () => {
  const projects = [
    ...
    {
      title: 'ECHO-chat',
      description: 'Engaged Conversation with Human Oversight (ECHO) chat is a responsive personal chatbot powered by Gemini 2 langauge model, designed for natural, context-aware conversations across a wide range of topics.',
      technologies: [ 'RAG','gemini-2.0 LLM', 'llamaindex','FastAPI', 'Azure Container app'],
      status: 'completed' as const,
      link: 'https://github.com/sharondevs/echo_chat',
